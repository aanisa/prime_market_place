marketApp.factory('MarketService', [function() {
    ...
    class UserAcc {
        ...
        DecBal(salePrice) {
            ...
            console.log('User Bal', this.balance);
            this.balance -= salePrice;
    ...
    // let user = new UserAcc(StartingBalance);
    ...
    //market object houses the array, marketItems
    let market = {};
